...
@section('content')
    <main class="main">
        ...
        <!-- About Section -->
        <section id="about" style="padding-bottom: 0px" class="about section">
            <div class="container section-title" data-aos="fade-up">
                <h2>Tentang Kami</h2>
                <p>Platform kami memungkinkan anggota untuk mendaftar ke berbagai acara yang sedang diadakan.</p>
            </div>
            <div class="container">
                <div class="row gy-5">
                    <div class="content col-xl-5 d-flex flex-column" data-aos="fade-up" data-aos-delay="100">
                        <h3>Solusi untuk Pendaftaran Acara</h3>
                        <p>
                            Kami menyediakan layanan untuk mempermudah anggota dalam mendaftar ke acara yang menarik dan
                            relevan.
                        </p>
                        {{-- <a href="#" class="about-btn align-self-center align-self-xl-start"><span>Tentang Kami</span>
                    ...
                    <div class="col-xl-7" data-aos="fade-up" data-aos-delay="200">
                        <div class="row gy-4">
                            <div class="col-md-6 icon-box position-relative">
                                ...
                                <h4><a href="" class="stretched-link">Pendaftaran Mudah</a></h4>
                                <p>Daftar ke acara dengan cepat dan mudah melalui platform kami.</p>
                            </div>
                            <div class="col-md-6 icon-box position-relative">
                                <i class="bi bi-people"></i>
                                <h4><a href="" class="stretched-link">Komunitas</a></h4>
                                <p>Bergabung dengan komunitas yang memiliki minat yang sama.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="stats-item d-flex">
                                    ...
                                    <div>
                                        ...
                                        <p><strong>Orang</strong> <span>telah mendaftar</span></p>
                                    </div>
                                </div>
                            </div><!-- End Stats Item -->
                                ...
                                <div class="stats-item d-flex">
                                    ...
                                    <div>
                                        <span data-purecounter-start="0" data-purecounter-end="521"
                                            data-purecounter-duration="1" class="purecounter"></span>
                                        <p><strong>Acara</strong> <span>telah dibuat</span></p>
                                    </div>
                                </div>
                            </div><!-- End Stats Item -->
                                ...
                                <div class="stats-item d-flex">
                                    ...
                                    <div>
                                        <span data-purecounter-start="0" data-purecounter-end="123"
                                            data-purecounter-duration="1" class="purecounter"></span>
                                        <p><strong>Penghargaan</strong> <span>telah didapatkan</span></p>
                                    </div>
                                </div>
                            </div><!-- End Stats Item -->
                                ...
                                <div class="stats-item d-flex">
                                    ...
                                    <div>
                                        <span data-purecounter-start="0" data-purecounter-end="32"
                                            data-purecounter-duration="1" class="purecounter"></span>
                                        <p><strong>Panitia</strong> <span>selalu siap melayani</span></p>
                                    </div>
                                </div>
                            </div><!-- End Stats Item -->
        ...
        <section id="alt-services" style="padding-top: 0px;" class="alt-services section">
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                <div class="row gy-4">
