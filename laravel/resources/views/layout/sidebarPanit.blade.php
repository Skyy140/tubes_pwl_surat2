...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/panit/dashboard">
        <div class="sidebar-brand-icon rotate-n-15">
            <i class="fas fa-calendar-alt"></i>
        </div>
        <div class="sidebar-brand-text mx-3">Eventku</div>
    </a>
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item{{ request()->is('panit/dashboard') ? ' active' : '' }}">
        <a class="nav-link" href="/panit/dashboard">
